...
{{
    ...
    for face in faces:
        ...
        file_name = f"{skybox_name}_{face}.vmt"
        file_path = os.path.join(output_dir, file_name)
        
        # Create the VMT content by replacing the placeholder in the template
        vmt_content = vmt_template.format(texture_name=f"{skybox_name}_{face}")
...
skybox_name = "skyboxname"  # Change this to your desired skybox name
